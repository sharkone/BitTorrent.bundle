...
def menu():
    ...
    object_container.add(InputDirectoryObject(key=Callback(search_menu, title='Search', per_page=31), title='Search', summary="Search anime", thumb=R('search.png'), prompt="Search for"))
